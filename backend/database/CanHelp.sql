...
-- RF09: Chat entre cliente e cuidador durante a solicitação/prestação do serviço.
-- As mensagens ficam amarradas ao Contrato (a "conversa" é o contrato em si),
-- e só o cliente e o cuidador daquele contrato podem trocar mensagens nele.
CREATE TABLE Mensagem(
    ...
    CONSTRAINT fkMensagemContrato
    FOREIGN KEY (idContrato)
    REFERENCES Contrato (idContrato)
    ON DELETE CASCADE,

    CONSTRAINT fkMensagemRemetente
